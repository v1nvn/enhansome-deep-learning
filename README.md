# Awesome Deep Learning [![Awesome](https://cdn.rawgit.com/sindresorhus/awesome/d7305f38d29fed78fa85652e3a63e154dd8e8829/media/badge.svg)](https://github.com/sindresorhus/awesome) ⭐ 453,360 | 🐛 59 | 📅 2026-04-02
...
*You can also find the most cited deep learning papers from [here](https://github.com/terryum/awesome-deep-learning-papers) ⭐ 26,108 | 🐛 36 | 🌐 TeX | 📅 2024-01-18*
...
2. [Pytorch Tutorial by Yunjey Choi](https://github.com/yunjey/pytorch-tutorial) ⭐ 32,254 | 🐛 88 | 🌐 Python | 📅 2023-08-15
3. [TensorFlow tutorials](https://github.com/nlintz/TensorFlow-Tutorials) ⭐ 6,024 | 🐛 16 | 🌐 Jupyter Notebook | 📅 2023-08-20
4. [More TensorFlow tutorials](https://github.com/pkmital/tensorflow_tutorials) ⭐ 5,663 | 🐛 10 | 🌐 Jupyter Notebook | 📅 2021-12-11
5. [TensorFlow-World](https://github.com/astorfi/TensorFlow-World) ⭐ 4,505 | 🐛 3 | 🌐 Python | 📅 2020-12-23
6. [Classification on raw time series in TensorFlow with a LSTM RNN](https://github.com/guillaume-chevalier/LSTM-Human-Activity-Recognition) ⭐ 3,545 | 🐛 22 | 🌐 Jupyter Notebook | 📅 2022-11-06
...
1. [Fashion-MNIST](https://github.com/zalandoresearch/fashion-mnist) ⭐ 12,694 | 🐛 33 | 🌐 Python | 📅 2022-06-13 - MNIST like fashion product dataset consisting of a training set of 60,000 examples and a test set of 10,000 examples. Each example is a 28x28 grayscale image, associated with a label from 10 classes.
2. [Open Images dataset](https://github.com/openimages/dataset) ⭐ 4,366 | 🐛 37 | 🌐 Python | 📅 2021-07-01 - Open Images is a dataset of \~9 million URLs to images that have been annotated with labels spanning over 6000 categories.
...
1. [Tensorflow - Open source software library for numerical computation using data flow graphs](https://github.com/tensorflow/tensorflow) ⭐ 194,580 | 🐛 4,241 | 🌐 C++ | 📅 2026-04-09
2. [PyTorch - Tensors and Dynamic neural networks in Python with strong GPU acceleration](https://github.com/pytorch/pytorch) ⭐ 98,936 | 🐛 18,259 | 🌐 Python | 📅 2026-04-09
3. [SyntaxNet - Google's syntactic parser - A TensorFlow dependency library](https://github.com/tensorflow/models/tree/master/syntaxnet) ⭐ 77,674 | 🐛 1,281 | 🌐 Python | 📅 2026-04-02
4. [Colossal-AI - An Integrated Large-scale Model Training System with Efficient Parallelization Techniques](https://github.com/hpcaitech/ColossalAI) ⭐ 41,370 | 🐛 493 | 🌐 Python | 📅 2026-04-09
5. [Paddle - PArallel Distributed Deep LEarning by Baidu](https://github.com/baidu/paddle) ⭐ 23,810 | 🐛 1,507 | 🌐 C++ | 📅 2026-04-09
...
9. [char-rnn](https://github.com/karpathy/char-rnn) ⭐ 12,020 | 🐛 110 | 🌐 Lua | 📅 2023-10-24
10. [convetjs](https://github.com/karpathy/convnetjs) ⭐ 11,148 | 🐛 75 | 🌐 JavaScript | 📅 2023-01-07
11. [Sonnet - a library for constructing neural networks by Google's DeepMind](https://github.com/deepmind/sonnet) ⭐ 9,913 | 🐛 40 | 🌐 Python | 📅 2026-02-10
...
16. [Flax - a neural network ecosystem for JAX that is designed for flexibility](https://github.com/google/flax) ⭐ 7,148 | 🐛 480 | 🌐 Jupyter Notebook | 📅 2026-04-08
...
18. [Feast - A Feature Store for ML for GCP by Gojek/Google](https://github.com/gojek/feast) ⭐ 6,916 | 🐛 342 | 🌐 Python | 📅 2026-04-08
19. [PyTorch Geometric Temporal - Representation learning on dynamic graphs](https://github.com/gojek/feast) ⭐ 6,916 | 🐛 342 | 🌐 Python | 📅 2026-04-08
...
25. [lightly - A computer vision framework for self-supervised learning](https://github.com/lightly-ai/lightly) ⭐ 3,714 | 🐛 85 | 🌐 Python | 📅 2026-03-24
26. [Catalyst: High-level utils for PyTorch DL & RL research. It was developed with a focus on reproducibility, fast experimentation and code/ideas reusing](https://github.com/catalyst-team/catalyst) ⭐ 3,374 | 🐛 3 | 🌐 Python | 📅 2025-06-27
...
30. [Karate Club - An unsupervised machine learning library for graph structured data](https://github.com/benedekrozemberczki/karateclub) ⭐ 2,275 | 🐛 12 | 🌐 Python | 📅 2024-07-17
31. [garage - A toolkit for reproducible reinforcement learning research](https://github.com/rlworkgroup/garage) ⭐ 2,094 | 🐛 234 | 🌐 Python | 📅 2023-05-04
32. [Knet.jl](https://github.com/denizyuret/Knet.jl) ⭐ 1,435 | 🐛 153 | 🌐 Jupyter Notebook | 📅 2024-11-15
33. [MatConvNet: CNNs for MATLAB](https://github.com/vlfeat/matconvnet) ⭐ 1,433 | 🐛 687 | 🌐 Cuda | 📅 2021-12-21
34. [Deeppy](https://github.com/andersbll/deeppy) ⭐ 1,376 | 🐛 22 | 🌐 Python | 📅 2020-12-28
...
39. [hebel](https://github.com/hannes-brt/hebel) ⭐ 1,171 | 🐛 6 | 🌐 Python | 📅 2020-12-29
...
48. [Maze](https://github.com/enlite-ai/maze) ⭐ 286 | 🐛 2 | 🌐 Python | 📅 2026-04-02 - Application-oriented deep reinforcement learning framework addressing real-world decision problems.
...
1. [Netron](https://github.com/lutzroeder/netron) ⭐ 32,715 | 🐛 18 | 🌐 JavaScript | 📅 2026-04-08 - Visualizer for deep learning and machine learning models
2. [hub](https://github.com/activeloopai/Hub) ⭐ 9,063 | 🐛 64 | 🌐 C++ | 📅 2026-02-16 - Fastest unstructured dataset management for TensorFlow/PyTorch by activeloop.ai. Stream & version-control data. Converts large data into single     numpy-like array on the cloud, accessible on any machine.
3. [Nebullvm](https://github.com/nebuly-ai/nebullvm) ⭐ 8,347 | 🐛 111 | 🌐 Python | 📅 2024-07-22 - Easy-to-use library to boost deep learning inference leveraging multiple deep learning compilers.
4. [TensorBoard](https://github.com/tensorflow/tensorboard) ⭐ 7,138 | 🐛 736 | 🌐 TypeScript | 📅 2026-04-02 - TensorFlow's Visualization Toolkit
...
1. [AI Expert Roadmap](https://github.com/AMAI-GmbH/AI-Expert-Roadmap) ⭐ 30,887 | 🐛 18 | 🌐 JavaScript | 📅 2025-09-12 - Roadmap to becoming an Artificial Intelligence Expert
2. [Machine Learning for Software Engineers](https://github.com/ZuzooVn/machine-learning-for-software-engineers) ⭐ 28,741 | 🐛 30 | 📅 2024-06-11
3. [Microsoft Recommenders](https://github.com/Microsoft/Recommenders) ⭐ 21,606 | 🐛 174 | 🌐 Python | 📅 2026-04-09 contains examples, utilities and best practices for building recommendation systems. Implementations of several state-of-the-art algorithms are provided for self-study and customization in your own applications.
4. [Face recognition with Google's FaceNet deep neural network.](https://github.com/cmusatyalab/openface) ⭐ 15,412 | 🐛 6 | 🌐 Lua | 📅 2024-10-04
...
Have anything in mind that you think is awesome and would fit in this list? Feel free to send a [pull request](https://github.com/ashara12/awesome-deeplearning/pulls) ⭐ 27,863 | 🐛 62 | 📅 2025-05-26.
